...
static char *fonts[]          = { "Go:size=12:antialias=true:autohint=true", "monospace:size=12", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_masculine,	spawn,	{.v = (const char*[]){ "dmenuunicode", NULL } } },
	...
	{ MODKEY|ShiftMask,		XK_BackSpace,	spawn,		{.v = (const char*[]){ "tmux-tfg", NULL } } },
	...
	{ Mod1Mask|ShiftMask,		XK_h,		shifttag,	{ .i = -1 } },
	{ MODKEY,			XK_h,		setmfact,	{.f = -0.05} },
	/* J and K are automatically bound above in STACKEYS */
	{ MODKEY,			XK_l,		setmfact,      	{.f = +0.05} },
	{ Mod1Mask,			XK_l,		shiftview,	{ .i = 1 } },
	{ Mod1Mask|ShiftMask,		XK_l,		shifttag,	{ .i = 1 } },
	...
	{ MODKEY,			XK_c,		spawn,		{.v = (const char*[]){ "favtxt-sc", NULL } } },
	/* { MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("") }, */
	/* V is automatically bound above in STACKKEYS */
	{ MODKEY,			XK_b,		spawn,		{.v = (const char*[]){ "favtxt-all", NULL } } },
	{ MODKEY|ShiftMask,		XK_b,		togglebar,	{0} },
	{ MODKEY,			XK_n,		spawn,		{.v = (const char*[]){ "favtxt-nav", NULL } } },
	...
	{ 0, XF86XK_Sleep,		spawn,		{.v = (const char*[]){ "doas", "-A", "zzz", NULL } } },
	{ 0, XF86XK_WWW,		spawn,		{.v = (const char*[]){ BROWSER, NULL } } },
	{ 0, XF86XK_DOS,		spawn,		{.v = termcmd } },
	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("slock & xset dpms force off; mpc pause; pauseallmpv") },
	{ 0, XF86XK_TaskPane,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "htop", NULL } } },
	{ 0, XF86XK_Mail,		spawn,		SHCMD(TERMINAL " -e aerc ; pkill -RTMIN+12 dwmblocks") },
